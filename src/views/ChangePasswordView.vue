<template>
  <q-layout view="hhr lpr lff" class="bg-blue-grey-1">
    <q-page-container>
      <div style="width: 100%; height: 150px" class="row justify-center">
        <div style="width: 100%" class="row justify-center q-mt-lg">
          <q-img
      ...
      <div style="width: 100%" class="row justify-center">
        <q-card style="min-width: fit-content; width: 30%; border-radius: 10px">
          <q-card-section horizontal>
            <div class="q-pa-sm row justify-between" style="width: 100%">
              <div class="text-h6 q-pa-sm">Crea una nueva contraseña</div>
              <q-btn
                round
                flat
                icon="help"
        ...
        >
          <q-card-section horizontal>
            <div
              ...
              style="width: 100%"
            >
              <div class="text-h6 q-pa-sm">Crear una contraseña segura</div>
              <q-btn
          ...
          <q-card-section class="q-mb-md">
            <div class="text-grey-7 text-body1"></div>
            <div class="row text-grey-8">
              Sigue las siguientes recomendaciones para crear una contraseña
              <q-badge class="q-ml-xs" label="Optima" color="green-13" />
            </div>
...
import { passwordChange, sendEmail } from "src/services/mail.js";
...
import {
  sendPasswordChangedInformation,
  passwordChangedInformation,
        ...
        if (userEmail.value != "" && userPhoneNumber.value != null) {
          ...
          sendPasswordChangedInformation(
            passwordChangedInformation(
              ...
              "reclutamiento@turbomaquinas.com"
            )
          );
